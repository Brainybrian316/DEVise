  ...
  return (
    ...
    >
      {devProjects.map((devProject) => (
        <Card
          key={devProject._id}
          sx={{ minWidth: "450px", maxWidth: "300px", m: 2 }}
        >
          <Box sx={{ display: "flex", justifyContent: "flex-start" }}>
            <Typography variant="h6">{devProject.title}</Typography>
          </Box>
          ...
          <AspectRatio minHeight="120px" maxHeight="200px" sx={{ my: 2 }}>
            <img src={devProject.mainImage} alt={devProject.title} />
          </AspectRatio>
          <Typography level="body2">{devProject.summary}</Typography>
          <Box sx={{ display: "flex", pt: 2 }}>
            <div>
              <Typography level="body3">
                Created By: {devProject.authors}
              </Typography>
            </div>
          </Box>
