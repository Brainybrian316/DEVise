...
export const devList = [
  {
    ...
    github: 'https://github.com/Brainybrian316',
    linkedin:'https://www.linkedin.com/in/brainybrian316/',
    portfolio: 'https://braiybrian316.com/',
    image: require('../../assets/images/prof-b.jpeg'),
    bio: 'Brian is a Mission-driven full-stack Web Developer and Educator with a passion for thoughtful UI/UX, collaboration, and teaching. Holding a Certificate in Web Development from the University of Central Florida. An innovative problem-solver with a passion for developing apps. Strong ability to communicate, collaborate, be creative, and understand agile software development principles.'
  },
  {
    id: 2,
    name: 'Vince T',
